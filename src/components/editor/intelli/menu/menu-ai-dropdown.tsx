...
export const MenuAiDropdown = ({ editor }: { editor: Editor }) => {
  ...
  return (
    <DropdownMenu.Root aria-label="Center aligned">
      <DropdownMenu.Trigger asChild>
        <button
          className={
            "ToggleGroupItem flex items-center justify-center relative"
          }
          value="center"
        ...
        >
          <div
            className={
              "absolute top-0 right-0 transform -translate-x-1 -translate-y-0.5"
            }
          >
            <div
              className={
                "absolute px-1 text-[0.75rem] bg-pink-500 text-white rounded-md font-semibold"
              }
            >
              AI
            </div>
